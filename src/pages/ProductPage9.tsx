...
// @ts-ignore
import img6 from "../assets/prod9-assets/6.png";// @ts-ignore
import img5 from "../assets/prod9-assets/5.png";// @ts-ignore
import img4 from "../assets/prod9-assets/4.png";// @ts-ignore
import img3 from "../assets/prod9-assets/3.jpg";// @ts-ignore
import img2 from "../assets/prod9-assets/2.jpg";// @ts-ignore
import img1 from "../assets/prod9-assets/1.jpg";// @ts-ignore

const ProductPage9 = () => {

    const product = {
        title: "OHLINS TES MU00S1 Road & Track (DFV) Damper kit for TESLA MODEL 3 & MODEL Y, 2017-, set w springs (springs included)",
        characteristics: [
            {name: "Гарантія", value: "", description: "2 роки"},
            {name: "Нижче", value: "", description: "на 5 - 30 мм стадарту"},
            {name: "Жорсткість пружини", value: "", description: "110 Н/мм"},
        ],
    ...
    return (
        <>
            ...
            <div className={"flex justify-between px-10 my-5 aeroport-light"}>
                ...
                <a href="https://www.atomic-shop.ua/ohlins-tes-mu00s1-road-track-dfv-damper-kit-for-tesla-model-3-model-y-2017-set-w-springs-springs-included">
