...
// @ts-ignore
import img6 from "../assets/prod8-assets/6.png";// @ts-ignore
import img5 from "../assets/prod8-assets/5.png";// @ts-ignore
import img4 from "../assets/prod8-assets/4.png";// @ts-ignore
import img3 from "../assets/prod8-assets/3.jpg";// @ts-ignore
import img2 from "../assets/prod8-assets/2.jpg";// @ts-ignore
import img1 from "../assets/prod8-assets/1.jpg";// @ts-ignore

const ProductPage8 = () => {

    const product = {
        title: "OHLINS VWS MU21 до-т підвіски Road & Track (DFV) VAG MQB 2012 -, set",
        characteristics: [
            {name: "Гарантія", value: "", description: "2 роки"},
            {name: "Стандарт", value: "", description: "ISO 9227"},
            {name: "Жорсткість пружини", value: "", description: "70 Н/мм"},
        ],
    ...
    return (
        <>
            ...
            <div className={"flex justify-between px-10 my-5 aeroport-light"}>
                ...
                <a href="https://www.atomic-shop.ua/ohlins-vws-mu21-road-track-dfv-damper-kit-for-vag-mqb-2012-set-springs-sold-separately">
