...
// @ts-ignore
import img6 from "../assets/prod7-assets/6.png";// @ts-ignore
import img5 from "../assets/prod7-assets/5.png";// @ts-ignore
import img4 from "../assets/prod7-assets/4.png";// @ts-ignore
import img3 from "../assets/prod7-assets/3.jpg";// @ts-ignore
import img2 from "../assets/prod7-assets/2.jpg";// @ts-ignore
import img1 from "../assets/prod7-assets/1.jpg";// @ts-ignore

const ProductPage7 = () => {

    const product = {
        title: "OHLINS MAS MP00S2 Койловери комплект ROAD & TRACK для MAZDA MX-5 (ND/RF)",
        characteristics: [
            {name: "Гарантія", value: "", description: "2 роки"},
            {name: "Нижче", value: "", description: "на 5 - 30 мм стадарту"},
            {name: "Жорсткість пружини", value: "", description: "100 Н/мм"},
        ],
